...
author: "Crithian Jhovany Gutierrez Jimenez"
date: "`r Sys.Date()`"
output:
...
R = Si replace se establece en FALSE en el código anterior, significa que no se permitirá el reemplazo de elementos en la muestra. 
